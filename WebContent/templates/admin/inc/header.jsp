        ...
        <div id="header">
            ...
            <div id="subnav">
                <div class="container_12">
                    <div class="grid_12">
                        <ul>
                            <li><a class = "btn btn-primary" href="<%=request.getContextPath()%>/admin/indexNew">Khách hàng</a></li>
                            <li><a class = "btn btn-success" href="<%=request.getContextPath()%>/admin/indexCat">Vắc xin</a></li>
                            <li><a class = "btn btn-destroy" href="<%=request.getContextPath()%>/admin/indexUser">Bệnh</a></li>
                            <li><a class = "btn btn-destroy" href="<%=request.getContextPath()%>/admin/indexUser">Phòng Bệnh</a></li>
                            <li><a class = "btn btn-destroy" href="<%=request.getContextPath()%>/admin/indexUser">Lịch Sử Tiêm Phòng</a></li>
                        </ul>
                    </div><!-- End. .grid_12-->
                </div><!-- End. .container_12 -->
                <div style="clear: both;"></div>
